...
Therefore 1 cent = \tz\num{0.01} = one hundredth of a tez.
...
a vote. Stakeholders may cast a vote for, against or can choose to explicitly
...
to specific addresses for the next cycle. See figure \ref{fig:pos_figure}.
...
withholding of the numbers which could be used to attack the entropy of the seed. 
...
denouncing malfeasance, but it's not particularly clear this carries much
benefit.}
...
static type checking. Its design is inspired by Forth, Scheme, ML and Cat.
